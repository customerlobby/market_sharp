  ...
  class Client
    module Transactions
      ...
      def transactions(params = {})
        ...
        connection.Jobs.skip(page * page_size).top(page_size).filter("#{date_to_filter_on} ge datetime'#{start_date}'").filter("#{date_to_filter_on} le datetime'#{end_date}'").expand('Contract')
